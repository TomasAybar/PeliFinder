        ...
        <>
            {
                isLoading
                    ...
                    : (
                        <div className='text-center flex items-center justify-center flex-col container mx-auto min-h-[85vh]'>
...

                            {
                                platforms?.length > 0 &&
                                (
                                    <div className='flex flex-col items-center justify-center border border-dashed border-gray-300 w-full p-5 my-10'>
                                                ...
                                                <div className='mt-3'>
                                                    {platforms.map((plat, index) => (
                                                        <p className='mb-2' key={index}>
                                                            <a className='text-yellow-400 font-bold cursor-pointer hover:text-[#E3011F]'
                                                                href={plat.url}
